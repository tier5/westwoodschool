...
if ( ! class_exists( 'MPC_Single_Post' ) ) {
	class MPC_Single_Post {
		...
		function enqueue_shortcode_scripts() {
			wp_enqueue_style( 'mpc_single_post-css', mpc_get_plugin_path( __FILE__ ) . '/shortcodes/mpc_single_post/css/mpc_single_post.css', array(), MPC_MASSIVE_VERSION );
			wp_enqueue_script( 'mpc_single_post-js', mpc_get_plugin_path( __FILE__ ) . '/shortcodes/mpc_single_post/js/mpc_single_post' . MPC_MASSIVE_MIN . '.js', array( 'jquery' ), MPC_MASSIVE_VERSION );
		}
