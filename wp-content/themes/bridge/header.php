...
.header_top_bottom_holder {
 ...
 header.menu_position_left .header_inner .header_inner_left {
    float: left;
    left: auto !important;
...
.menu-inner .header_inner_left nav.main_menu ul#menu-main-menu li .inner ul li ul {
    left: 100% !important;
    top: 0 !important; width: 250px !important;
}
.menu-inner .header_inner_left nav.main_menu ul#menu-main-menu li .inner ul li ul li {
     width: 100% !important;
}
.menu-inner .header_inner_left nav.main_menu ul#menu-main-menu li .inner ul li ul li span{
    color:#fff !important;
    font-size:13px !important
}
.menu-inner .header_inner_left nav.main_menu ul#menu-main-menu li .inner ul li ul li span:hover{
    color:#81d742 !important
}
.page_header .header_inner .header_top {
    height: 36px;
}
.page_header .header_inner .header_top .right .header-widget ul li a {
    line-height: 34px;
}
.single .content {
    top: 70px;
...
header.page_header .header_inner .header_bottom .menu-inner .right-il {
...
.page_header .header_inner .header_top .left {
    display: none !important;
}
.page_header .header_inner .header_top {
    height: 40px!important;
}
.page_header .header_inner .inner {
    margin: 0 !important;
}
.page_header .header_inner .inner .header-widget ul li a {
    line-height: 40px !important;
}
.header_top .left, .header_top .right {
    height: 40px !important;
}
.header_bottom .menu-inner .header_inner_left .mobile_menu_button {
...
.header_bottom .menu-inner .header_inner_left .mobile.samrav {
    float: left;
...
<header class="<?php echo $header_classes; ?> page_header">
	...
	<?php } ?>
	<div class="header_bottom sam3 clearfix" <?php echo $header_color_per_page; ?> >
		    <?php if($header_in_grid){ ?>
				<div class="container">
...
<img class="mobile samrav" itemprop="image" src="http://westwoodschool.org/wp-content/uploads/2016/12/Westwood-Logo.png" alt="Logo">
						...
						<img class="right-il sam" src="http://westwoodschool.org/wp-content/uploads/2016/08/ib-world-school-logo-2-colour.png">
					</div>
                    <?php if($header_bottom_appearance == "stick_with_left_right_menu") { ?>
					...
					<?php if($header_bottom_appearance != "stick menu_bottom" && $header_bottom_appearance != "stick_with_left_right_menu"){ ?>
                        ...
                        <?php if(!$centered_logo) { ?>
							<div class="header_inner_right sam11">
						...
						<?php if($centered_logo) { ?>
							<div class="header_inner_right sam12">
                                <div class="side_menu_button_wrapper right">
									<?php if(is_active_sidebar('header_bottom_right')) { ?>
										<div class="header_bottom_right_widget_holder"><?php dynamic_sidebar('header_bottom_right'); ?></div>
									<?php } ?>
						...
						<div class="header_menu_bottom">
						    <div class="header_menu_bottom_inner">
								...
								<?php } ?>
									...
									<div class="header_inner_right sam13">
										<div class="side_menu_button_wrapper right">
											<?php if(is_active_sidebar('header_bottom_right')) { ?>
												<div class="header_bottom_right_widget_holder"><?php dynamic_sidebar('header_bottom_right'); ?></div>
											<?php } ?>
	...
	<header class="<?php echo $header_classes; ?> page_header">
		...
		<?php } ?>
			<div class="header_top_bottom_holder">
				...
				<?php } ?>
				<div class="header_bottom sam1 clearfix" <?php echo $header_color_per_page; ?> >
						<?php if($header_in_grid){ ?>
							<div class="container">
								<div class="container_inner clearfix">
								<?php if($overlapping_content) {?><div class="overlapping_content_margin"><?php } ?>
...
<?php } else{?>
	<header class="page_header <?php if($display_header_top == "yes"){ echo 'has_top'; }  if($header_top_area_scroll == "yes"){ echo ' scroll_top'; }?> <?php if($centered_logo){ echo " centered_logo"; } ?> <?php echo $header_bottom_appearance; ?>  <?php echo $header_style; ?> <?php if(is_active_sidebar('header_fixed_right')) { echo 'has_header_fixed_right'; } ?>">
        <div class="header_inner clearfix">
			<div class="header_bottom  sam2 clearfix" <?php echo $header_color_per_page; ?> >
				<?php if($header_in_grid){ ?>
				<div class="container">
					<div class="container_inner clearfix">
                        <?php if($overlapping_content) {?><div class="overlapping_content_margin"><?php } ?>
